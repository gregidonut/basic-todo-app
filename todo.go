...
// Add creates a nwe todo item and appends it to the list
...
func (l *List) Get(filename string) error {
	...
	// we ignore the error if the file doesn't exist(or is empty (next block))
	// presumably because if this method returns nil the consumer of this method
	// will create the file or handle an empty output differently
	if err != nil {
